...
.PHONY: help migrate goose sqlx test clean install build
...
help:
	...
	@echo "  make clean       Remove generated goose/sqlx files and __pycache__"
...
clean:
	...
	rm -f migrations/.goose migrations/.sqlx 2>/dev/null || true
